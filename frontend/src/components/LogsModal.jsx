      ...
      >
        ...
        <div className="flex items-center justify-between p-5 border-b border-gray-200">
          <div>
            ...
            <p className="text-sm text-gray-500">Full details for Logs and Outcomes Details</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-5 overflow-y-auto text-sm flex-grow">
          <div className="space-y-3 font-mono">
            {logEntries.map((entry, index) => {
                ...
                return (
                    <div key={index} className="flex flex-col md:flex-row md:items-baseline text-color">
                        {timestamp && (
