...
const PatientFormModal = ({ open, onClose, onSubmit, editingPatient }) => {
  ...
  const initialValues = {
    ...
    dateOfBirth: editingPatient?.dateOfBirth ? new Date(editingPatient.dateOfBirth) : null
  };
      ...
      <Modal open={open} onClose={onClose}>
        <Box sx={style} component="form" onSubmit={formik.handleSubmit}>
          ...
          <TextField
            ...
            name="age"
            label="Age"
            value={calculatedAge ? `${calculatedAge} years` : 'Select date of birth to calculate age'}
            disabled
